define(["require", "exports", "./film"], function (require, exports, film_1) {
    "use strict";
    ...
    var FilmArray = (function () {
        ...
        //     return indexArray;
        // }
        // public retrieveDataStats(selectedArray): InfoDisplay {
        //     let selected: number[] = this.getSelectedIndexes(selectedArray);
        //     let revenueSum: number = 0;
        //     for (let i = 0; i < selected.length; i++) {
        //         revenueSum += this.films[selected[i]].revenue;
        //     }
        //     let years: number[] = [];
        //     for (let i = 0; i < selected.length; i++) {
        //         years.push(this.films[selected[i]].year);
        //     }
        //     return new InfoDisplay(selected.length, (revenueSum / selected.length), this.min(years), this.max(years));
        // }
        FilmArray.prototype.max = function (array) {
            return Math.max.apply(Math, array);
        };
        FilmArray.prototype.min = function (array) {
            return Math.min.apply(Math, array);
        };
        FilmArray.prototype.orderFilmsByField = function (arr, field) {
            arr.sort(this.propertySort(field));
        };
        FilmArray.prototype.propertySort = function (property) {
            var sortOrder = 1;
            if (property[0] === "-") {
                sortOrder = -1;
